...

{
  ...
  "captions": {
    "justListed": "Instagram/Facebook caption for a Just Listed post. Match the agent's ${agent.style} style. 3-4 sentences + 5 relevant hashtags. Include price and key details naturally.",
    "underContract": "Instagram/Facebook caption for an Under Contract post. Celebratory, thank the community, hint at another listing coming. Match ${agent.style} style. 2-3 sentences + 3 hashtags.",
    "priceReduced": "Instagram/Facebook caption for a Price Reduced post. Urgent but not desperate. Highlight the new opportunity. Match ${agent.style} style. 2-3 sentences + 3 hashtags.",
    "sold": "Instagram/Facebook caption for a Sold post. Celebratory, thank the buyers/sellers, reflect on the journey. Match ${agent.style} style. 3-4 sentences + 4 hashtags."
  },
  "graphicText": {
