      ...
      <div className="bg-cream w-full sm:max-w-[640px] sm:rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-screen sm:max-h-[90vh]">
        ...
        <div className="bg-deep px-8 pt-7 pb-5 flex-shrink-0">
          <div className="flex justify-between items-start mb-5">
            <div>
              <p className="font-sans text-[0.7rem] uppercase tracking-[0.15em] text-blush/70 mb-1">Order Form</p>
              <h2 className="font-serif text-[1.4rem] text-white">Social Media Graphics</h2>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                {STEP_LABELS.map((label, i) => (
                  <span
                    key={i}
                    className="font-sans text-[0.64rem] transition-colors duration-200"
