          ...
          {step === 0 && (
            <div className="space-y-5">
              <div>
                ...
                <p className="font-sans text-[0.87rem] text-slate mb-6">This personalizes everything we generate for your brand.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <input className={iCls} placeholder="Keller Williams Realty" value={agent.brokerage} onChange={e => setAgent(a => ({ ...a, brokerage: e.target.value }))} />
              </div>
              <div>
              ...
              <button
                onClick={() => setStep(1)}
                disabled={!agent.name || !agent.brokerage}
